                  ...
                  >
                    ...
                    >
                      <div className={`grid gap-4 ${
                        ...
                        modelList.length === 2 ? (sidebarCollapsed ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1 md:grid-cols-2') :
                        modelList.length === 3 ? (sidebarCollapsed ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3') :
                        sidebarCollapsed ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3'
                      }`}>
                        {modelList.map((model) => (
                          <SortableChatPanel
                            key={model.id}
